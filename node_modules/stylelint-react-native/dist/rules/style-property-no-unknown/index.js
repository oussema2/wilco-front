...
var ruleName = (0, _utils.namespace)("style-property-no-unknown");
...
function _default(actual, options) {
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      ...
      if ((0, _utils.kebabCase)(prop) === (0, _utils.kebabCase)(value)) {
        return;
      }
