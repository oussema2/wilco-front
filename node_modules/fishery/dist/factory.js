...
var Factory = /** @class */ (function () {
    ...
    Factory.prototype.builder = function (params, options) {
        if (params === void 0) { params = {}; }
        if (options === void 0) { options = {}; }
        return new builder_1.FactoryBuilder(this.generator, this.sequence(), __assign(__assign({}, this._params), params), __assign(__assign({}, this._transient), options.transient), __assign(__assign({}, this._associations), options.associations), this._afterBuilds, this._onCreates);
    };
    return Factory;
}());
