...
class CometChatMessages extends React.PureComponent {
  ...
  render() {
    const { onChatProfilePressed, onSendMessageButtonPressed } = this.props;
    const { route } = this.props;
    const params = route?.params || this.props;
    let imageView = null;
    ...
    let messageComposer = (
      <CometChatMessageComposer
        ...
        onSendMessageButtonPressed={onSendMessageButtonPressed}
      />
    );
        ...
        <KeyboardAvoidingView
          ...
          <SafeAreaView style={style.chatWrapperStyle}>
            ...
            <CometChatMessageHeader
              ...
              loggedInUser={params.loggedInUser}
              actionGenerated={this.actionHandler}
              onChatProfilePressed={onChatProfilePressed}
            />
